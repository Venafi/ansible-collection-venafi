...
short_description: Requests and retrieves SSH certificates from CyberArk platforms.
description:
    - This is the CyberArk SSH certificate module for working with CyberArk Certificate Manager, Self-Hosted.
...
options:
    ...
    ssh_key_generation_type:
        description:
            ...
            - C(service). The SSH Key Pair is generated by the CyberArk Certificate Manager, Self-Hosted server and returned in the response.
...
class VSSHCertificate:
    ...
    def revoke(self):
        if os.path.exists(self.certificate_filename):
            os.remove(self.certificate_filename)
            self.changed = True
    ...
    def dump(self):
        ...
        if self.state == "present":
            ...
            result['ssh_certificate_removed'] = self.certificate_filename
