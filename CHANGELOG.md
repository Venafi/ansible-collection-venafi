...
* NGTS supports certificate operations only. The `venafi_policy`, `venafi_ssh_certificate`, and `venafi_ssh_ca` modules fail fast with a clear message when NGTS credentials are supplied.
